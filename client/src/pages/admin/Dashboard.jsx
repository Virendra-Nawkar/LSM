...
const Dashboard = () => {
    ...
    // Safely map over the purchasedCourse array
    const courseData = purchasedCourse?.map((course) => {
        // Ensure courseId and courseTitle exist before accessing them
        if (course.courseId) {
            return {
    ...
    return (
        <div className='grid grid-6 grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4'>
